...
app.post("/api/ai/improve-visit", async (req, res) => {
  try {
    ...
    const system = [
      ...
      "- Subjective: 'Patient reports [pain/complaint].' — not 'has pain', not 'is in pain'.",
      "  For ongoing pain without new detail: 'Pain persists.' or 'Ongoing [location] pain.'",
      "- Objective: passive voice for interventions — 'Therapeutic exercises were performed.',",
      "  'Manual therapy was applied.' — not 'did exercises', 'worked on', 'focused on'.",
      ...
      "- Plan: 'Continue current treatment.' or specific next steps from the source only.",
